...
public class ParticleCarver extends AnimationApplet {
	...
	class NoiseWalker {
		...
		void render() {
			...
			colorMode(RGB);
			int blue_C = color(testx / testx * 20, 100 + cvaly, 255 + cvalx);
			int green_C = color(100 - cvaly, 155 + cvaly, cvalx - 20);
			int yellow_C = color(100 + cvaly, 255 + cvalx, testx / testx * 20);
			int red_C = color(255 + cvalx, cvaly, testx / testx * 20);
